            ...
            <header className={`${styles.header}`}>
                <nav className={`${styles.nav} mt-4 mb-4`}>
                  ...
                  <div className={`${styles.item} pl-5 pr-5 pt-4 pb-4 ml-4`}>
                    ...
                    <h2 className="text text_type_main-default text_color_inactive pl-2">Лента заказов</h2>
                  </div>
                </nav>
                ...
                <div className={styles.button}>
                  ...
                  <h2 className="text text_type_main-default text_color_inactive pl-2">Личный кабинет</h2>
